...
class GovernmentSchemeRequest extends StatefulWidget {
  const GovernmentSchemeRequest({Key? key}) : super(key: key);

  @override
  _GovernmentSchemeRequestState createState() =>
      _GovernmentSchemeRequestState();
}

class _GovernmentSchemeRequestState extends State<GovernmentSchemeRequest> {
      ...
      body: Container(
        ...
        child: Column(
          children: [
            CustomDropDown(
                hint: "Select scheme",
                itemList: Strings.governmentSchemes,
